...
public class BoardTest {
    ...
    public void testClear() {
        ...
        a.addSpot(Side.RED, 3);
        a.addSpot(Side.BLUE, 4);
        a.addSpot(Side.RED, 3);
        a.clear(3);
        assertFalse("Amount does not exists", a.exists(10));
    }
    ...
    public void testNumOfSide() {
        ...
        b.set(1, 1, Side.BLUE);
        b.set(2, 2, Side.BLUE);
        assertEquals("incorrect ammount", 2, b.numOfSide(Side.BLUE));
    }

    @Test
    public void testNumPieces() {
        Board b = new MutableBoard(4);
        assertEquals("incorrect number of squares", 16, b.numPieces());
    }
