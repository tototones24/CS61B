...
abstract class Board extends Observable {
    ...
    /** (Re)initialize me to a $ed board with N squares on a side. Clears
    ...
    public String toString() {
        ...
        for (int r = 1; r <= size(); r++) {
            for (int c = 1; c <= size(); c++) {
                Square square = this.get(r, c);
                if (c == 1) {
                    if (this.get(r, c).getSide() == WHITE) {
                        System.out.print("    " + square.getSpots()
                            + "-" + " ");
                    } else if (this.get(r, c).getSide() == RED) {
                        System.out.print("    " + square.getSpots()
                            + "r" + " ");
                    } else {
                        System.out.print("    " + square.getSpots()
                    ...
                    if (this.get(r, c).getSide() == WHITE) {
                        System.out.println(square.getSpots() + "-" + " ");
                    } else if (this.get(r, c).getSide() == RED) {
                        System.out.println(square.getSpots() + "r" + " ");
                    } else {
                        System.out.println(square.getSpots() + "b" + " ");
                    }
                } else {
                    if (this.get(r, c).getSide() == WHITE) {
                        System.out.print(square.getSpots() + "-" + " ");
                    } else if (this.get(r, c).getSide() == RED) {
                        System.out.print(square.getSpots() + "r" + " ");
                    } else {
                        System.out.print(square.getSpots() + "b" + " ");
                    }
                }
            }
        }
